  ...
  return new Promise((resolve, _reject) => {
    db.transaction(
      (tx) => {
        ...
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
          ["Dry Dishes", "rebeccapurple", "silverware-fork-knife", 11, 1]
        );
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
        ...
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
          ["Put rubbish out", "saddlebrown", "trash-can-outline", 17, 4]
        );
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
        ...
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
          ["Do Homework", "darkgreen", "book-open-page-variant", 22, 6]
        );
        tx.executeSql(
          "insert into tasks (task_name, task_colour, task_icon, task_points, category_id) values (?,?,?,?,?)",
    ...
    db.transaction(
      (tx) => {
        tx.executeSql(
          ...
          ["Play Console", 20, 1, "trophy"]
        );
        tx.executeSql(
          "insert into rewards (reward_name, reward_points, icon_id, reward_icon_name) values (?,?,?,?)",
          ["Go Karting", 40, 2, "lock"]
        );
      },
      (t, error) => {
